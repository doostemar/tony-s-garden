...
# reusable data resource for any permanent / tiered buff
# granted by radishes, shop items, maybe quests, etc.
...
# example:
# 0.20 means each tier adds +20% to that stat multiplier.
# t1 => 1.20x
# t2 => 1.40x
# t3 => 1.60x
@export_range(0.01, 10.0, 0.01) var modifier_per_tier: float = 0.20

@export_range(1, 99, 1) var max_tier: int = 3
